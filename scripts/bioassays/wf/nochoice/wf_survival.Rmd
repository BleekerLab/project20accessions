...
output:
    html_document:
        ...
        toc_depth: 2  
params: 
  data: "../../../../results/01.bioassays/wf/20160311_wf_5days/20160311_wild.txt"
...
wf = read.table(file = inputdata,header = T,sep = "\t",na.strings = "NA",stringsAsFactors=F)
```
...
deviances = c(deviance(fit1),deviance(fit2),deviance(fit3),deviance(fit4))
...
probas = ggplot(coefs,aes(accession,prob)) + 
